...
class UseCaseHandlerChild implements iUseCaseHandler
{
    ...
    public static function addGiftToChild($giftId, $childId, $kingId) {
        
        $connect = DatabaseConnnection::connect();
        $query = "INSERT INTO ninos_regalos_rey (ninos_id, regalos_id, rey_id) VALUES ($childId, $giftId, $kingId)";
        mysqli_query($connect, $query);
